...
##### 开发与学习
  ...
  * [Axure](https://www.axure.com/edu) - 免费 1 年，产品原型工具
  ...
  * [MATLAB](https://ww2.mathworks.cn/academia/tah-support-program/eligibility.html?s_tid=tfa_student_licenseCheck) - 需要高校获取授权。用于算法开发、数据可视化、数据分析以及数值计算的高级技术计算语言和交互式环境
  * [Simulink](https://ww2.mathworks.cn/academia/tah-support-program/eligibility.html?s_tid=tfa_student_licenseCheck) - 需要高校获取授权。用于动态系统和嵌入式系统的多领域模拟和基于模型的设计工具
...
##### VPS
  ...
  * [腾讯云](https://cloud.tencent.com/act/campus) - 可以以10元/月的价格购买云服务器（1C2G1M），赠送50GB对象存储和8元.cn域名优惠资格。另可以以3/6/9元购买云数据库服务
  * [阿里云](https://promotion.aliyun.com/ntms/campus2017.html) - 可以以9.5元/月的价格购买轻量应用服务器或云服务器

##### 域名
  * Namecheap - Github教育礼包，免费一年SSL证书，一年.me域名
  * [腾讯云](https://cloud.tencent.com/act/campus) - 学生可享受8元.cn域名优惠资格
...
* [Office 365 教育版](https://signup.microsoft.com/signup?sku=Education) - OneDrive 1TB免费存储
